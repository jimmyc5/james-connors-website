...
export default function About(){
    return (
        <div className="d-flex justify-content-center col-12">
            <div class="col-11 col-lg-9 justify-content-center d-flex flex-wrap">
                ...
                <div className="col-12 d-flex justify-content-center align-items-stretch flex-wrap">
                    ...
                    <div className="col-md-8 col-12">
                        ...
                        <p> My interest in programming started when I made simple video games online using Scratch- turns out a childhood playing video games and a passion to create lit a fire under me to make software I can be proud of. </p> 
                        <p> And as I delved into programming languages and other tools in high school and college, I quickly found that passion spreading to all areas of software development. Nowadays I work on web development, game development, and more.</p> 
